...
import {
  AddUserCommand, QuestionVM, UserQuestionsClient} from '../cleanarchitecture-api';
...
export class QuestionsComponent {
  ...
  constructor(private questionsClient: UserQuestionsClient, private modalService: BsModalService) {
    questionsClient.getQuestions().subscribe(
            result => {
                this.vm = result;
            },
